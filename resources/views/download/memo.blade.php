...
<body>
    ...
    <div  style="position:relative;max-width:1500px;height:1262px; margin: auto;">
        ...
        <p style="position:absolute;top:180px;left:54px;white-space:nowrap" class="ft00"><b>REF.: {{$memo->facture->client->nom}}</b></p>
        <p style="position:absolute;top:180px;left:457px;white-space:nowrap" class="ft00"><b>ORDER Nº</b> {{$memo->facture->numeroCommande}}</p>

        <p style="position:absolute;top:210px;left:42px;white-space:nowrap" class="ft01"><b>CLIENT:{{$memo->facture->client->raisonSocial}}</b></p>
