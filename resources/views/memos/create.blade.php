...
<div class="row g-4 settings-section">
	<div class="col-12 col-md-4">
		...
		<div class="section-intro">Formulaire d'ajout de memo</div>
	</div>
				...
				<form class="settings-form" method="post" action="">
					<div class="row mb-3">
						<div class="col">
							...
							<input type="date" class="form-control" id="setting-input-1" required name="amarrageNavire">
						</div>
						<div class="col">
							...
							<input type="date" class="form-control" id="setting-input-1" required name="desamarrageNavire">
						</div>
					</div>
					...
					<button type="submit" class="btn app-btn-primary"> Creer un memo</button>
				</form>
			</div><!--//app-card-body-->
