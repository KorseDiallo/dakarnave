		...
		<div class="col-12 col-lg-10">
			<div class="app-card app-card-account shadow-sm d-flex flex-column align-items-center">
				...
				<div id="page1-div" style="position:relative;width:100%;height:1262px; padding-left:30px">
					...
					<p style="position:absolute;top:160px;left:54px;white-space:nowrap" class="ft00"><b>REF.:{{$memo->ficheDetravail->facture->client->nom}}</b></p>
					<p style="position:absolute;top:150px;left:457px;white-space:nowrap" class="ft00"><b>ORDER Nº</b> {{$memo->ficheDetravail->facture->numeroCommande}}</p>
 
					<p style="position:absolute;top:202px;left:42px;white-space:nowrap" class="ft01"><b>CLIENT:{{$memo->ficheDetravail->facture->client->raisonSocial}}</b></p>
