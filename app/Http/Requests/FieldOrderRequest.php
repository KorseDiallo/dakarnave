...
class FieldOrderRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'ownerItem' => 'required|string',
            'dknvItem' => 'required|string',
            'typeDemande' => 'nullable|in:ajout,modification,annueller',
            'titreElement' => 'required|string',
            'elementsImpacter' => 'required|string',
